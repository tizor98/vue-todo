...
type Prop = { todo?: Todo, index?: number }
const props: Readonly<Prop> = defineProps(["todo", "index"])
...
<template>
   <li>
      ...
      <div class="todo-actions">
         ...
         <Icon v-else icon="ph:pencil-fill" class="icon edit-icon" color="#41b080" width="22" @click="$emit('edit-todo', index)" />
